...
SOURCES := Entities.cpp EncodeDecodeMSG.cpp IrReceiver.cpp InitGameControl.cpp DisplayControl.cpp MSGDecoderControl.cpp ProcessHitControl.cpp RegisterGameParamsControl.cpp ShootControl.cpp UpdateGametimeControl.cpp Speaker.cpp SpeakerControl.cpp DigitLedDisplay.cpp

# header files in this project
HEADERS := ADTs.hpp IRunGameTaskDummy.hpp EncodeDecodeMSG.hpp IrReceiver.hpp PauseDetectionControl.hpp IrTransmitter.hpp SendIrMessageControl.hpp Keyboard_4x4.hpp Speaker.hpp SpeakerControl.hpp DisplayControl.hpp TransferData.hpp Entities.hpp ShootControl.hpp IRunGameTask.hpp IRunGameTaskDummy.hpp MSGDecoderControl.hpp RegisterGameParamsControl.hpp ProcessHitControl.hpp UpdateGameTimeControl.hpp DigitLedDisplay.hpp note.hpp
