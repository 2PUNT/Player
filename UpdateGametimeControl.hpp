...
public:
	UpdateGameTimeControl(const unsigned int priority, const char* taskName, RemainingTime& _remainingTime, DigitLedDisplay& _digitLedDisplay, ShootControl& _shootControl, ProcessHitControl& _processHitControl, SpeakerControl& _speakerControl):
